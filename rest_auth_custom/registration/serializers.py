...
class RegisterSerializer(serializers.Serializer):
    ...
    phone = serializers.CharField(max_length=256, required=True, write_only=True)
    employer_code = serializers.CharField(max_length=256, required=True, write_only=True)
