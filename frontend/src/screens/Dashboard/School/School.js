...
const School = (props) => {
  ...
  const {
    admins: { loadingAdmins, adminSuccess, adminError, adminData },
    ...
    <div className="dashboard overveiw">
      <div id="siderbar" className="d-flex flex-column col">
        ...
        <div className="inner-section h-100 p15">
          <BuildingCard image="assets/building-img.jpg" name="St. Xaviers International School" sectionno="4" roomno="12" />
        </div>
      </div>
      <div className="main-content w-100">
        <div className="main-content-tabs-section">
          <SelectedBuliding image="assets/building-img.jpg" name="St. Xaviers International School" />
          <Navbar />
