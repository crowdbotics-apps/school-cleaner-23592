			...
			<div className="tabs-inner-content-holder">
				<div className="tabs-siderbar">
					...
					<div className="section-list-holder">
						{
							sections.map(item => <SectionsCard
								id={item.id}
				...
				<div className="tabs-inner-block">
					{
						showDetails ?
							...
							<SectionsDetails sectionDetails={sectionDetails} rooms={rooms} HandelDeleteSchool={HandelDeleteSchool} sections={sections}
								fetchSection={fetchSection}
								fetchRoomData={fetchRoomData} />
					}
				</div>
			</div>
			{openSectionModal ? <SectionForm school={school}
