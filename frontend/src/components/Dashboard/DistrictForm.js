...
const DistrictForm = (props) => {
  ...
  const {
    generateCode: { loading, success, error, data },
          ...
          <div className="modal-content">
            <div className="modal-body">
              <form onSubmit={submitHandler}>
                <CSRFToken />
                <h2 className="modal-title mb-4" id="exampleModalLabel">
                  Add District
                </h2>
                <div className="mb-4">
                ...
                <div className="logo-uploader mb-4">
                  ...
                  <div className="logo-uploader-area">{base64Image == '' ? <p>Drag & drop the image in this section</p> : <img src={base64Image} height="100px" />}</div>
                </div>
                <div className="mb-4">
                  <div className="form-floating mb-3 go-bottom">
                    <input type="text" name="code" value={data} onChange={handleCodeChange} className="form-control" id="floatingInput" placeholder="District code" />
                    <label htmlFor="name">District code</label>
                  </div>
                </div>
                <button type="submit" className="btn btn-primary text-uppercase" data-bs-toggle="modal" data-bs-target="#add_District">
                  Create
                </button>
              </form>
            </div>
