    ...
    return (
        <div class="building-card-holder mb15">
            <div class="building-image" onClick={props.handleClick}>
                {
                    emptyImage ? <img src={props.image} alt="" className="image-responsive w-100" /> :
                        <img src="assets/empty-image.png" alt="" className="image-responsive w-100" />
                }
                            ...
                            <div class="icon-holder">
                                <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                        <li><a className="dropdown-item" data-toggle="modal" onClick={onOpenEditModal}>Edit details</a></li>
                                        <li><a className="dropdown-item" onClick={onOpenDeleteModal}>Delete School</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="building-details-holder">
                            <p class="m-0"><span>{props.sectionno}</span> Sections | <span>{props.roomno}</span> Rooms</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="align-items-center building-card-footer d-flex p15" onClick={props.handleClick}>
                ...
                <h6 class="m-0">show details</h6>
            </div>
            {
                openEditModal ? <SchoolEdit
                    open={openEditModal}
