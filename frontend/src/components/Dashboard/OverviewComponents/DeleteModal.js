...
export default function DeleteModal(props) {
  return (
    <Modal className="deleteBuildingModal" open={props.open} onClose={props.onCloseModal} center>
      <div>
        ...
        <div className="deleteButtons">
          <button type="button" className="ml-4 btn btn-primary" onClick={props.onDelete}>
            Delete
          </button>
