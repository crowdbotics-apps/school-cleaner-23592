    ...
    if (form.checkValidity() === true) {
      const obj = {
        roomDetail: {
          ...
          desks: roomDetail.desks,
          square_feet: roomDetail.square_feet,
          room_type: roomDetail.room_type,
          section: props.sectionDetails.id,
        },
                ...
                <div className="mb-4">
                  ...
                  <div className="form-floating mb-3 go-bottom">
                    ...
                    <select name="room_type" className="form-control" list="room_type" onChange={handleChange} id="room_type">
                      ...
                      {roomsType?.map((item) => (
                        <option style={{ fontWeight: 'bolder' }} id={item.id} value={item.id}>
                          {item.name}
                        </option>
                      ))}
                    </select>
                  ...
                  {/* <select name="section" className="form-control" list="sections" placeholder=" Section"> */}
                  ...
                  <div className="form-floating mb-3 go-bottom">
                    <input autocomplete="off" type="text" className="form-control" name="desks" required={true} id="floatingInput" placeholder="Desk" onChange={handleChange} />
