        ...
        <>
            ...
            <div className="section-details">
                <div className="d-flex justify-content-between p15 section-details-header align-items-center">
                    ...
                    {tabValue === 'people' ? <div className="d-flex header-button justify-content-between">
                    ...
                    </div> : tabValue === 'rooms' ? <div className="d-flex header-button justify-content-between">
                ...
                <div className="section-details-content">
                    <ul className="d-flex justify-content-between nav nav-tabs mt-2" id="myTab" role="tablist">
                        <li className="nav-item text-center col" role="presentation">
                            <button className="nav-link w-100 active" id="Details-tab" data-bs-toggle="tab" data-bs-target="#Details" type="button" role="tab" aria-controls="Details" aria-selected="true" onClick={() => setTabValue('details')}>Details</button>
                        </li>
                        <li className="nav-item text-center col" role="presentation">
                            <button className="nav-link w-100" id="Rooms-tab" data-bs-toggle="tab" data-bs-target="#Rooms" type="button" role="tab" aria-controls="Rooms" aria-selected="false" onClick={() => setTabValue('rooms')}>Rooms</button>
                        </li>
                        <li className="nav-item text-center col" role="presentation">
                            <button className="nav-link w-100" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false" onClick={() => setTabValue('people')}>People</button>
                        </li>
                    </ul>
                    <div className="tab-content" id="myTabContent">
                            ...
                            <div className="inner-tab-section-list-holder">
                                <ul className="section-list-block p-0 m-0">
                                    ...
                                    <li className="inner-tab-section-list-item d-flex justify-content-between">
                                        ...
                                        <div className="list-content">
                                            {sectionDetails.square_feet ? sectionDetails.square_feet : 0}
                                        </div>
                                    </li>
                                    <li className="inner-tab-section-list-item d-flex justify-content-between">
                                        <div className="list-label">
                                        ...
                                        <div className="list-content">
                                            {sectionDetails.desks ? sectionDetails.desks : 0}
                                        </div>
                                    </li>
                                    {/* <li className="inner-tab-section-list-item d-flex justify-content-between">
                                        <div className="list-label">
                        ...
                        <div className="tab-pane fade" id="Rooms" role="tabpanel" aria-labelledby="Rooms-tab">
                            <div className="inner-tab-section-list-holder room-block">
                                <ul className="section-list-block p-0 m-0">
                                    {rooms.map(room => <li onClick={() => setRoomId(room.id)} className="border d-flex flex-column inner-tab-section-list-item justify-content-between m15">
                                        <div className="list-label">
                                            {room.name}
                                        </div>
